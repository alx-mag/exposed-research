...
---
## 6. [TODO] Бенчмарки: производительность Exposed vs JPA
...
## 7. [TODO] Экосистема и сообщество
...
Исследование запросов "Kotlin Exposed" в Google Trends

### 7.3. Компании

Исследовать какие компании используют Exposed

### 7.4. Документация и обучение

Лендинг для Exposed появился недавно. 
Документация появилась недавно.

Нужно исследовать, какие есть статьи по Exposed на обучающих ресурсах: Baeldung, Habr, Medium, YouTube, Stepik

### 7.5. Рынок вакансий
Упоминание Exposed в вакансиях на hh.ru, linked.in

### 7.6. Критика

Исследовать, есть ли какое-то мнение об Exposed в блогах, твиттах, видео. Какие выделяются положительные/отрицательные/нейтральные моменты?

### 7.7. Перспективы

Какие планы по развитию проекта? Что может ожидать его в будущем
...
**Exposed** — проект на Kotlin, команда ценит контроль над SQL, используется Spring Boot с Kotlin-first подходом.
